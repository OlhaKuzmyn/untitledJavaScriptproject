...
//     // let divDurOr = document.createElement('div')
//     // divCont.append(divDurOr)
//     for (let key in coursesElement) {
//         if (key==='title'){
//             let titleHeader = document.createElement('h2')
//             titleHeader.innerText = `${coursesElement[key]}`
//             divCont.append(titleHeader)
//         } else if (key === 'monthDuration' || key === 'hourDuration'){
//             let divDur = document.createElement('div')
//             divDur.innerText = `${key}: ${coursesElement[key]}`
//             divCont.append(divDur)
//         } else if (key==='modules') {
//             let divMod = document.createElement('div')
//             let ulMod = document.createElement('ul')
//             for (let i = 0; i < coursesElement[key].length; i++) {
//                 let liMod = document.createElement('li')
//                 liMod.innerText = `${coursesElement[key][i]}`
//                 ulMod.append(liMod)
//             }
//             divMod.append(ulMod)
//             divCont.append(divMod)
//         }
//     }
// }
...
//             let divDur = document.createElement('div')
//             divDur.innerText = `Month Duration: ${coursesElement[key]}`
//             divCont.append(divDur)
//         } else if (key === 'hourDuration'){
//             let divDur = document.createElement('div')
//             divDur.innerText = `Hour Duration: ${coursesElement[key]}`
//             divCont.append(divDur)
//         }else if (key==='modules') {
//             let divMod = document.createElement('div')
//             let ulMod = document.createElement('ul')
